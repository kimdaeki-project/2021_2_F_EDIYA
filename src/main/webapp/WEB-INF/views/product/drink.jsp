				          	...
				          	<ul class="pro_n bxSlider" style="width: 28215%; position: relative; transition-duration: 0s; transform: translate3d(-1969.92px, 0px, 0px);">
					          	<li style="float: left; list-style: none; position: relative; width: 393px;" class="bx-clone" aria-hidden="true">
									<a href="#c" onclick="show_slide_detail('184')">
										<span class="new_icon">
											<img src="https://ediya.com/images/common/best_icon.png" alt="new">
										</span>
								...
								<li aria-hidden="true" style="float: left; list-style: none; position: relative; width: 393px;">
									<a href="#c" onclick="show_slide_detail('309')">
										<span class="new_icon">
											<img src="/images/common/best_icon.png" alt="new">
										</span><img src="/files/menu/IMG_1563238180331.png" alt="흑당 라떼">
									</a>
									<p><a href="#c" onclick="show_slide_detail('309')">흑당 라떼</a></p>
								</li>
								<li aria-hidden="true" style="float: left; list-style: none; position: relative; width: 393px;">
									<a href="#c" onclick="show_slide_detail('310')">
										<span class="new_icon">
											<img src="/images/common/best_icon.png" alt="new">
										</span><img src="/files/menu/IMG_1563238936785.png" alt="(EX)흑당 라떼">
									</a>
									<p><a href="#c" onclick="show_slide_detail('310')">(EX)흑당 라떼</a></p>
								</li>
								<li aria-hidden="true" style="float: left; list-style: none; position: relative; width: 393px;">
									<a href="#c" onclick="show_slide_detail('311')">
										<span class="new_icon">
											<img src="/images/common/best_icon.png" alt="new">
										</span><img src="/files/menu/IMG_1563239291456.png" alt="ICED흑당 콜드브루">
									</a>
									<p><a href="#c" onclick="show_slide_detail('311')">ICED흑당 콜드브루</a></p>
								</li>
								<li aria-hidden="true" style="float: left; list-style: none; position: relative; width: 393px;">
									<a href="#c" onclick="show_slide_detail('312')">
										<span class="new_icon">
											<img src="/images/common/best_icon.png" alt="new">
										</span><img src="/files/menu/IMG_1563241039133.png" alt="(EX)ICED흑당 콜드브루">
									</a>
									<p><a href="#c" onclick="show_slide_detail('312')">(EX)ICED흑당 콜드브루</a></p>
								</li>
								<li aria-hidden="true" style="float: left; list-style: none; position: relative; width: 393px;">
									<a href="#c" onclick="show_slide_detail('313')">
										<span class="new_icon">
											<img src="/images/common/best_icon.png" alt="new">
										</span>
										<img src="/files/menu/IMG_1563242110490.png" alt="버블 흑당 라떼">
									</a>
									<p><a href="#c" onclick="show_slide_detail('313')">버블 흑당 라떼</a></p>
								</li>
								<li aria-hidden="true" style="float: left; list-style: none; position: relative; width: 393px;">
									<a href="#c" onclick="show_slide_detail('314')">
										<span class="new_icon">
											<img src="/images/common/best_icon.png" alt="new">
										</span>
										<img src="/files/menu/IMG_1563250399596.png" alt="(EX)버블 흑당 라떼">
									</a>
									<p><a href="#c" onclick="show_slide_detail('314')">(EX)버블 흑당 라떼</a></p>
								</li>
								<li aria-hidden="true" style="float: left; list-style: none; position: relative; width: 393px;">
									<a href="#c" onclick="show_slide_detail('315')">
										<span class="new_icon">
											<img src="/images/common/best_icon.png" alt="new">
										</span><img src="/files/menu/IMG_1563250718130.png" alt="ICED버블 흑당 콜드브루">
									</a>
									<p><a href="#c" onclick="show_slide_detail('315')">ICED버블 흑당 콜드브루</a></p>
								</li>
								<li aria-hidden="true" style="float: left; list-style: none; position: relative; width: 393px;">
									<a href="#c" onclick="show_slide_detail('316')">
										<span class="new_icon">
											<img src="/images/common/best_icon.png" alt="new">
										</span>
										<img src="/files/menu/IMG_1563250807738.png" alt="(EX)ICED버블 흑당 콜드브루">
									</a>
								...
								<li aria-hidden="true" style="float: left; list-style: none; position: relative; width: 393px;">
									<a href="#c" onclick="show_slide_detail('333')">
										...
										<img src="/files/menu/IMG_1569485085454.png" alt="ICED연유 카페라떼 ">
									</a>
									<p><a href="#c" onclick="show_slide_detail('333')">ICED연유 카페라떼 </a></p>
								</li>
								<li aria-hidden="true" style="float: left; list-style: none; position: relative; width: 393px;">
									<a href="#c" onclick="show_slide_detail('332')">
										<span class="new_icon">
											<img src="/images/common/best_icon.png" alt="new">
										</span>
										<img src="/files/menu/IMG_1569484383380.png" alt="HOT연유 카페라떼 ">
									</a>
									<p><a href="#c" onclick="show_slide_detail('332')">HOT연유 카페라떼 </a></p>
								</li>
								<li aria-hidden="true" style="float: left; list-style: none; position: relative; width: 393px;">
									<a href="#c" onclick="show_slide_detail('334')">
										<span class="new_icon">
											<img src="/images/common/best_icon.png" alt="new">
										</span>
										<img src="/files/menu/IMG_1569485171449.png" alt="ICED연유 콜드브루">
									</a>
									<p><a href="#c" onclick="show_slide_detail('334')">ICED연유 콜드브루</a></p>
								</li>
								<li aria-hidden="true" style="float: left; list-style: none; position: relative; width: 393px;">
									<a href="#c" onclick="show_slide_detail('297')">
										<span class="new_icon">
											<img src="/images/common/best_icon.png" alt="new">
										</span>
										<img src="/files/menu/IMG_1558502162288.png" alt="ICED콜드브루 아메리카노">
									</a>
								...
								<li aria-hidden="true" style="float: left; list-style: none; position: relative; width: 393px;">
									<a href="#c" onclick="show_slide_detail('266')">
										...
										<img src="/files/menu/IMG_1529902646309.png" alt="(EX)ICED 유자피나콜라다">
									</a>
								...
								<li aria-hidden="true" style="float: left; list-style: none; position: relative; width: 393px;">
									<a href="#c" onclick="show_slide_detail('250')">
										...
										<img src="/files/menu/IMG_1524707533812.png" alt="꿀복숭아 플랫치노">
									</a>
									<p><a href="#c" onclick="show_slide_detail('250')">꿀복숭아 플랫치노</a></p>
								</li>
								<li aria-hidden="true" style="float: left; list-style: none; position: relative; width: 393px;">
									<a href="#c" onclick="show_slide_detail('248')">
										<span class="new_icon">
											<img src="/images/common/best_icon.png" alt="new">
											</span>
											<img src="/files/menu/IMG_1523925474425.png" alt="ICED콜드브루 라떼">
										</a>
								...
								<li aria-hidden="true" style="float: left; list-style: none; position: relative; width: 393px;">
									<a href="#c" onclick="show_slide_detail('249')">
										...
										<img src="/files/menu/IMG_1523925480622.png" alt="ICED콜드브루 화이트 비엔나">
									</a>
								...
								<li style="float: left; list-style: none; position: relative; width: 393px;" aria-hidden="true">
									<a href="#c" onclick="show_slide_detail('240')">
										...
										<img src="/files/menu/IMG_1511829751169.png" alt="석류 애플라임">
									</a>
									<p><a href="#c" onclick="show_slide_detail('240')">석류 애플라임</a></p>
								</li>
								<li style="float: left; list-style: none; position: relative; width: 393px;" class="bx-clone" aria-hidden="true">
									<a href="#c" onclick="show_slide_detail('320')">
										<span class="new_icon">
											<img src="/images/common/best_icon.png" alt="new">
										</span><img src="/files/menu/IMG_1564379279645.png" alt="이디야 콤부차 복숭아망고">
									</a>
									<p><a href="#c" onclick="show_slide_detail('320')">이디야 콤부차 복숭아망고</a></p>
								</li>
								<li style="float: left; list-style: none; position: relative; width: 393px;" class="bx-clone" aria-hidden="true">
