...
<!-- Start -->
	...
	<section id="container">
		...
		<div class="notice_banner members_main">
			<h1 class="banner_title">이디야멤버스</h1>
			<p class="banner_subtit">
				<span>이디야커피의 특별한 멤버십 서비스를 소개합니다.</span>
				스탬프적립, FREE쿠폰, 이벤트 혜택 등 지금 이디야멤버스에서 만나보세요.
			</p>
			
			<!-- lnb : local navigation bar -->
			<ul class="lnb">
				<li class="on"><a href="ediya_members_main" id="members01">멤버스소개</a></li>
